...
only search memorize or load personal information when the user owns it or is explicitly authorized to use it
never use memory tools to support personal-data resale spam or unauthorized surveillance
