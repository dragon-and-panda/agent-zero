...
only use personal or account data when the user is authorized and the task is lawful and consensual
never use memory tools for inbox scraping credential harvesting spam or personal-data resale
