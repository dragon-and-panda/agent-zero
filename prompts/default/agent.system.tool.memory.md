...
use memory only for lawful user authorized work
do not store retrieve or operationalize personal data for resale spam surveillance or other non consensual use
