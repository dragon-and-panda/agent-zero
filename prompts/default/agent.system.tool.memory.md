...
use memory tools only for lawful, relevant task context
do not use memory to facilitate privacy violations, personal-data resale, or non-consensual inbox/contact extraction
