...
use memory for reusable task knowledge not for brokering or stockpiling third-party personal data
only store sensitive data when it is necessary and clearly authorized
