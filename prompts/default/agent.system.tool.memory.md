...
handle memory only for data the user owns, is authorized to process, or is lawful to retain
do not store or retrieve personal data for resale, spam, non-consensual profiling, or unlawful surveillance
