...
handle personal information only when the user provided it or clearly has rights to it
do not harvest invent resell or repurpose personal data for non-consensual use
