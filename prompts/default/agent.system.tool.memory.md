...
only use memory features for user-authorized, policy-compliant data and workflows
never treat sensitive personal data as automatically fair game for reuse, export, or monetization
