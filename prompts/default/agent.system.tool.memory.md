...
store and retrieve personal info only when necessary for the active task and explicitly authorized
never use memory tools to build contact-brokerage datasets resale lists or privacy-invasive dossiers
