...
handle personal data minimally and only when the user lawfully controls it or consent is documented
never store secrets credentials or third-party personal data for resale outreach or surveillance
