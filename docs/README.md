...
- **[Agentic Financial System Blueprint](programs/agentic_financial_system/blueprint.md):** Compliance-first plan for an autonomous monetization and financial expansion program.
