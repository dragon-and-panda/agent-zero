...
- **[Compliance Pack](policies/compliance_pack.md):** Review legal, privacy, and consent guardrails for autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** See the compliant revenue-program blueprint.
- **[Strategy Intake Queue](strategy/incoming.md):** Track PASS, HOLD, and REJECT monetization lanes.
