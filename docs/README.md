...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful autonomous revenue and data workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant roadmap for an autonomous revenue program.
- **[Agentic Financial System Journal](programs/agentic_financial_system/journal.md):** Running mission diary for automation iterations.
