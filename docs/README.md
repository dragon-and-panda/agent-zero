...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-compatible autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliance-first revenue program scaffold.
