...
- **[Compliance Pack](policies/compliance_pack.md):** Revenue, privacy, consent, and legality rules for autonomous programs.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Mission charter for a compliant multi-lane revenue program.
- **[Agentic Financial System Revenue Plan](programs/agentic_financial_system/revenue_plan.md):** Phased execution plan for lawful monetization.
- **[Strategy Intake Rules](strategy/incoming.md):** GO/HOLD/REJECT examples for incoming opportunities.
...
- [Agentic Financial System Revenue Plan](programs/agentic_financial_system/revenue_plan.md)
- [Strategy Intake Rules](strategy/incoming.md)
