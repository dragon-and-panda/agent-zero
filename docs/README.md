...
- **[Self-Sustaining Financial Program](programs/self_sustaining_finance/mission_playbook.md):** Compliance-first roadmap for building an autonomous online revenue system.
