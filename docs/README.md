...
- **[Compliance Pack](policies/compliance_pack.md):** Review legal, privacy, consent, and platform-rule guardrails for revenue and automation workflows.
- **[Agentic Financial System](programs/agentic_financial_system/charter.md):** See the compliant financial-system charter, journal, and improvement backlog.
- **[Strategy Intake Queue](strategy/incoming.md):** Normalize and score new venture lanes before buildout.
