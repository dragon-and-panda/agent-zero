...
- **[Agentic Financial System Blueprint](agentic_financial_system.md):** Build an autonomous online income system with compliance-first data, monetization, and risk controls.
