...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-based autonomy and monetization.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Safe revenue program for autonomous execution.
- **[Strategy Intake Queue](strategy/incoming.md):** Approved, pending, and rejected venture candidates.
