...
- **[Autonomous Financial System Blueprint](autonomous_financial_system.md):** Compliance-first plan for autonomous revenue operations, consent-aware data workflows, and reinvestment discipline.
