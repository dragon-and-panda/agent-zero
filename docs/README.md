...
- **[Compliance Pack](policies/compliance_pack.md):** Review legal, privacy, consent, and market-behavior guardrails for autonomous work.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Track the mission, approved lanes, and operating boundaries for autonomous revenue work.
- **[Strategy Intake Queue](strategy/incoming.md):** Triage new monetization ideas before execution.
