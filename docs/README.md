...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for autonomous monetization, data use, and capital deployment.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Phased plan for compliant, redundant revenue generation.
