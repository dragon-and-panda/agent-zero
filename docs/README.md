...
- **[Autonomous Super-Agency Blueprint](autonomous_super_agency.md):** Design low-touch multi-agent operating models.
- **[Compliance Pack](policies/compliance_pack.md):** Rules for legal, ethical monetization and sensitive-data handling.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Mission, allowed revenue lanes, and operating loop.
- **[Strategy Intake Queue](strategy/incoming.md):** Evaluate monetization ideas before execution.
