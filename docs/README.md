...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-based autonomous workflows and monetization.
- **[Strategy Intake Queue](strategy/incoming.md):** Mission intake and prioritization queue for autonomous programs.
- **[Agentic Financial System Program](programs/agentic_financial_system/charter.md):** Compliant roadmap for first-party, productized, and service-based revenue lanes.
