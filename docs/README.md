...
- **[Compliance Pack](policies/compliance_pack.md):** Review the legal, privacy, and platform guardrails for autonomous workflows.
- **[Ethical Autonomous Financial System Blueprint](ethical_autonomous_financial_system.md):** Reframe autonomous monetization around consent-based, privacy-preserving revenue loops.
- **[Strategy Intake Queue](strategy/incoming.md):** Track candidate revenue lanes and rejected ideas.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Define the compliant mission, constraints, and initial revenue lanes.
...
- [Ethical Autonomous Financial System Blueprint](ethical_autonomous_financial_system.md)
