...
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliance-first blueprint for autonomous revenue systems built on consented data and repeatable services.
