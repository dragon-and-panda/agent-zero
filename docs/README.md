...
- **[Autonomous Super-Agency Blueprint](autonomous_super_agency.md):** A long-form operating model for low-touch autonomous programs.
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-based monetization and automation.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant revenue-program starter template.
