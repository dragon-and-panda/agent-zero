...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful monetization, privacy, and risk-managed autonomy.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Phased plan for compliant revenue generation, redundancy, and capital controls.
