...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for legal, privacy-safe revenue automation.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Phased plan for compliant, low-touch revenue operations.
