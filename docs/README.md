...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, privacy-safe autonomous operations.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant revenue lanes and operating rules.
- **[Strategy Intake Queue](strategy/incoming.md):** Score and track new monetization ideas.
