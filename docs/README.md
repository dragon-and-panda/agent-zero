...
- **[Program Playbooks](programs/agentic_financial_system/mission_blueprint.md):** Explore mission-ready execution blueprints, including the compliance-first Agentic Financial System program.
