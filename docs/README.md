...
- **[Autonomous Financial System Blueprint](autonomous_financial_system.md):** Launch a compliant, autonomous revenue-to-capital program with mission logs and improvement loops.
