...
- **[Autonomous Super-Agency Blueprint](autonomous_super_agency.md):** Configure low-touch multi-agent operations and governance patterns.
- **[Compliance Pack](policies/compliance_pack.md):** Review the rules for lawful, consent-based autonomous monetization.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Follow the compliant revenue-program blueprint and intake workflow.
