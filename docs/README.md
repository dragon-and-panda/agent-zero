...
- **[Compliance Pack](policies/compliance_pack.md):** Review the legal and privacy guardrails for autonomous revenue work.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** See the compliant mission, portfolio lanes, and activation rules.
- **[Strategy Intake Queue](strategy/incoming.md):** Track candidate revenue lanes and their pass, hold, or reject status.
