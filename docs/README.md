...
- **Program Blueprints:**
  - **[Autonomous Listing Service](programs/autonomous_listing/journal.md):** Example mission diary + iterative backlog.
  - **[Autonomous Financial System](programs/autonomous_financial_system/blueprint.md):** Compliance-first framework for data, monetization, and capital growth loops.
