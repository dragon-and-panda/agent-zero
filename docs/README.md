...
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Review the compliant revenue framework, intake rules, and operating loop for autonomous monetization programs.
