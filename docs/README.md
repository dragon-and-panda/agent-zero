...
- **[Compliance Pack](policies/compliance_pack.md):** Policy guardrails for privacy, consent, and lawful autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant revenue program for opt-in, first-party, and public-data ventures.
