...
- **[Compliance Pack](policies/compliance_pack.md):** Review the rules for lawful, consent-based autonomous revenue programs.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** See the compliant monetization lanes, operating rules, and activation criteria.
- **[Strategy Intake Queue](strategy/incoming.md):** Review candidate revenue lanes and their PASS, HOLD, or REJECT status.
