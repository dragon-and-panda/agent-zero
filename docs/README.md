...
- **[Compliance Pack](policies/compliance_pack.md):** Review privacy, consent, and monetization guardrails for autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Follow the lawful revenue program, operating lanes, and scoring process.
- **[Strategy Intake Queue](strategy/incoming.md):** See incoming mission ideas, their status, and rejection reasons for unsafe requests.
