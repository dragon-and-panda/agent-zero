...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, privacy-safe autonomy and monetization.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant mission plan for autonomous revenue generation.
- **[Strategy Intake Queue](strategy/incoming.md):** Candidate venture lanes with scorecard outcomes and next actions.
