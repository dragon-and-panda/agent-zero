...
- **[Compliance Pack](policies/compliance_pack.md):** Default privacy, legality, consent, and platform-rule guardrails for autonomous work.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant revenue-program blueprint centered on first-party data and opt-in acquisition.
