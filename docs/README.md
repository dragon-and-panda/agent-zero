...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for legal, consent-based autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant revenue program built on opt-in channels and legitimate services.
