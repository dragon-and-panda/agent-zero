...
- **[Compliance Pack](policies/compliance_pack.md):** Privacy, consent, and monetization guardrails for autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliance-first venture program for bounded revenue automation.
- **[Incoming Strategy Queue](strategy/incoming.md):** Intake and review format for new venture ideas.
