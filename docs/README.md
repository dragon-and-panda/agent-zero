...
- **[Agentic Financial System Program](programs/agentic_financial_system/blueprint.md):** Compliance-first blueprint for building an autonomous digital finance operation.
