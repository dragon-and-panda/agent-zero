...
- **[Compliance Pack](policies/compliance_pack.md):** Review the repo's default legal, privacy, and platform-safety rules for autonomous revenue work.
- **[Agentic Financial System Program](programs/agentic_financial_system/charter.md):** See the compliant revenue-system charter, mission diary, and improvement backlog.
...
- [Architecture Overview](architecture.md)
  ...
  - [Agentic Financial System Program Charter](programs/agentic_financial_system/charter.md)
