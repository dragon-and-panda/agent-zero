...
- **[Ethical Revenue Framework](ethical_revenue_framework.md):** Plan autonomous monetization around opt-in, first-party, and service-based workflows.
...
- **[Commercial Safety Policy](policies/commercial_safety.md):** Guardrails for revenue workflows that touch contacts, marketplaces, or customer data.
...
- [Ethical Revenue Framework](ethical_revenue_framework.md)
- [Commercial Safety Policy](policies/commercial_safety.md)
