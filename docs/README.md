...
- **[Compliance Pack](policies/compliance_pack.md):** Hard guardrails for lawful, privacy-respecting autonomous operations.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant blueprint for building autonomous revenue lanes.
- **[Strategy Intake Queue](strategy/incoming.md):** Capture and triage monetization ideas before execution.
