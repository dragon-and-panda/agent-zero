...
- **[Compliance Pack](policies/compliance_pack.md):** Operating rules for lawful, consent-based autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant blueprint for an autonomous revenue program.
