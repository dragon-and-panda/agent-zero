...
- **[Compliance Pack](policies/compliance_pack.md):** Review the privacy, consent, and legality guardrails for autonomous monetization workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Follow the compliant revenue-system blueprint and lane portfolio.
- **[Strategy Intake Queue](strategy/incoming.md):** Track candidate ventures before activation and score them consistently.
