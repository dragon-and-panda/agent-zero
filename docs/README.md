...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, privacy-respecting autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliant revenue program goals and lane definitions.
- **[Strategy Intake Queue](strategy/incoming.md):** Candidate revenue lanes and rejected examples.
