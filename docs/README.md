...
- **[Autonomous Financial System Program](programs/autonomous_financial_system/mission.md):** Mission blueprint for a compliant, automation-first online finance engine.
