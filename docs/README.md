...
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant, redundant plan for autonomous online revenue generation.
- **[Monetization Compliance Pack](policies/compliance_pack.md):** Guardrails for privacy, outreach, public-web research, and financial-risk handling.
...
- [Monetization Compliance Pack](policies/compliance_pack.md)
