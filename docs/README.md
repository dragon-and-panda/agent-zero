...
- **[Compliance Pack](policies/compliance_pack.md):** Review legality, privacy, and consent guardrails for autonomous workflows.
- **[Agentic Financial System Program](programs/agentic_financial_system/charter.md):** See the compliant revenue charter, journal, and improvement backlog.
