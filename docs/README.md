...
- **[Revenue Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-based monetization workflows.
- **[Opportunity Intake and Triage](strategy/incoming.md):** Score and classify new revenue ideas before activation.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Mission, approved lanes, and operating rules for autonomous revenue programs.
...
- [Opportunity Intake and Triage](strategy/incoming.md)
