...
- **[Compliance Pack](policies/compliance_pack.md):** Guardrails for privacy, monetization, and compliant autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliance-first roadmap for building durable revenue systems.
- **[Strategy Intake Queue](strategy/incoming.md):** Queue and score candidate ventures before implementation.
