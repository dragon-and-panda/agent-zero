...
- **[Agentic Financial System Program](programs/agentic_financial_system/mission.md):** Run a compliant financial flywheel mission with phased execution docs.
- **[Financial System Compliance Pack](policies/financial_system_compliance.md):** Apply hard guardrails for data privacy, outreach, and risk controls.
