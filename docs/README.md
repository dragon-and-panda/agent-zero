...
- **[Compliance Pack](policies/compliance_pack.md):** Review the standing legality, consent, privacy, and platform-policy rules for autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** See the compliant revenue program, lanes, and activation gates.
