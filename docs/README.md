...
- **[Compliance Pack](policies/compliance_pack.md):** Rules for legal, consent-based autonomous monetization and data handling.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** A compliant revenue-program blueprint for low-touch operation.
- **[Strategy Intake Queue](strategy/incoming.md):** Screen and score revenue lanes before activation.
