...
- **[Autonomous Super-Agency Blueprint](autonomous_super_agency.md):** Configure low-touch, multi-agent operations with governance.
- **[Agentic Financial System Compliance Pack](policies/compliance_pack.md):** Guardrails for lawful, consent-based monetization workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Mission charter, lane definitions, and operating cadence.
...
- [Architecture Overview](architecture.md)
  ...
  - [Agentic Financial System Compliance Pack](policies/compliance_pack.md)
