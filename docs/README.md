...
- **[Compliance Pack](policies/compliance_pack.md):** Revenue and data-handling guardrails for autonomous workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Consent-first monetization direction for low-touch venture building.
- **[Strategy Intake Queue](strategy/incoming.md):** Safe intake and triage list for new revenue ideas.
