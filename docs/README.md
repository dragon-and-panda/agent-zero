...
- **[Agentic Financial System Program](programs/agentic_financial_system/charter.md):** Compliance-first blueprint for autonomous revenue, treasury, and content operations.
