...
- **[Compliance Pack](policies/compliance_pack.md):** Hard rules for lawful, privacy-safe automation and monetization.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliance-first roadmap for autonomous revenue programs.
- **[Strategy Intake Queue](strategy/incoming.md):** Current PASS, HOLD, and REJECT monetization lanes.
