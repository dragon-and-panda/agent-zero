...
- **[Agentic Financial System Playbook](programs/financial_system/mission_playbook.md):** Launch a compliant, autonomous revenue program with phased growth controls.
