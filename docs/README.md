...
- **[Compliance Pack](policies/compliance_pack.md):** Non-negotiable rules for lawful autonomous revenue workflows.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Compliance-first monetization mission, venture lanes, and gating.
- **[Strategy Intake Queue](strategy/incoming.md):** Candidate revenue ideas, rejected ideas, and next-lane triage.
