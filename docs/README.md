...
- **[Compliance Pack](policies/compliance_pack.md):** Review the legal and ethical guardrails for autonomous revenue programs.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** See the compliance-first monetization program and approved lanes.
- **[Strategy Intake Queue](strategy/incoming.md):** Review active and rejected revenue ideas before implementation.
