...
- **[Autonomous Super-Agency Blueprint](autonomous_super_agency.md):** Design prompt, governance, and operations layers for low-touch agentic programs.
- **[Compliance Pack](policies/compliance_pack.md):** Apply privacy, consent, and monetization guardrails before any growth or data workflow.
- **[Agentic Financial System Charter](programs/agentic_financial_system/charter.md):** Run the revenue mission through compliant venture lanes instead of personal-data brokerage.
